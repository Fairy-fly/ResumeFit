...
| user_id | INTEGER | 关联 users.id |
| resume_profile_id | INTEGER | 可选关联 resume_profiles.id |
| name | TEXT | 项目名称 |
| role | TEXT | 用户角色 |
...
| responsibilities | TEXT | 关键职责 |
| achievements | TEXT | 成果和指标 |
| challenges | TEXT | 难点 |
| solutions | TEXT | 解决方案 |
| interview_notes | TEXT | 可追问细节 |
| authenticity_notes | TEXT | 真实性备注 |
| created_at | DATETIME | 创建时间 |
| updated_at | DATETIME | 更新时间 |
