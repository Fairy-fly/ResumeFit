...
| `AI_BASE_URL` | `https://api.example.com/v1` | OpenAI-compatible base URL |
| `AI_API_KEY` | `your_api_key_here` | AI API Key，占位符 |
| `AI_MODEL` | `your_model_name` | 模型名称 |
...
| Dashboard | 简历输入 |
| --- | --- |
| ![Dashboard](screenshots/dashboard.png) | ![Resume input](screenshots/resume-input.png) |

| 项目库 | JD 分析 |
| --- | --- |
| ![Project library](screenshots/project-library.png) | ![JD analysis](screenshots/jd-analysis.png) |

| 匹配度报告 | 简历版本 |
| --- | --- |
| ![Match report](screenshots/match-report.png) | ![Resume version](screenshots/resume-version.png) |

| 真实性风险检测 | 面试追问预测 |
| --- | --- |
| ![Truth check](screenshots/truth-check.png) | ![Interview questions](screenshots/interview-questions.png) |
